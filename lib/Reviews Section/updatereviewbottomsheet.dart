...
class UpdatecommentPage extends StatefulWidget {
  final String businessUid;
  final String commentId; // Updated from 'reviewId' to 'commentId'
  final String userId;
  final String currentReview;
  final int currentRating;
  ...
  const UpdatecommentPage({
    required this.businessUid,
    required this.commentId, // Updated from 'reviewId' to 'commentId'
    required this.userId,
    required this.currentReview,
    required this.currentRating,
    Key? key,
...
class _UpdatecommentPageState extends State<UpdatecommentPage> {
  ...
  List<String> _selectedSuggestions = []; // initially empty
  List<bool> _isSelected = [];
  final Set<String> _selectedReviews = {}; // Use Set to allow multiple selections
  final Set<String> _removedReviews = {}; // Keep track of removed reviews
  ...
  Color? _getColorForRating(int rating) {
    switch (rating) {
      ...
      case 3:
        return Colors.yellow[900];
      case 4:
        return Colors.teal[600]; // Assuming tgLightPrimaryColor is defined elsewhere
      case 5:
        return tgDarkPrimaryColor; // Assuming tgDarkPrimaryColor is defined elsewhere
      default:
        return Colors.grey; // Default color if rating is not within 1-5
  ...
  @override
  Widget build(BuildContext context) {
    var data = Provider.of<CommentSectionProviderNew>(context);
    return SingleChildScrollView(
      child: Padding(
        padding: const EdgeInsets.all(12.0),
        child: Column(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Icon(
                            ...
                            color: index < _currentRating
                                ? Colors.amberAccent[700]
                                : Colors.grey, // Update star color based on rating
                            size: 14,
                          ),
                        ],
                      ),
            ...
            ElevatedButton(
              onPressed: () async {
                await data
                    .editCommentProvider(
                      context: context,
                      commentId: widget.commentId, // Updated to use 'commentId'
