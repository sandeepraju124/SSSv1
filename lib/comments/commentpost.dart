                          ...
                          child: Padding(
                            ...
                            child: Container(
                              ...
                              child: RichText(text: TextSpan(
                                children: [
                                  TextSpan(text: data.getCommentsData?.comments[int].username, style: TextStyle(color: Colors.black)),
                                  TextSpan(text: ": ", ),
                                  TextSpan(text: data.getCommentsData?.comments[int].comment, style: TextStyle(color: Colors.grey))
                                ]
                              )),
                            ),
                          ),
