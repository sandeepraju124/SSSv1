...
// //   });
// //
// //   // ChatScreen({required this.userId, required this.conversationId});
// //
// //   @override
...
// //     _initSocket();
// //     print('ChatScreen: ${widget.userId} ${widget.businessId} ${widget.conversationId}');
// //   }
// //
...
// //                   : _isNewConversation
// //                   ? Center(child: Text('Start a new conversation'))
// //                   : ListView.builder(
// //                 reverse: true,
...
// //                     trailing: Text(DateTime.parse(message['timestamp'])
// //                         .toLocal()
// //                         .toString()
// //                         .split('.')[0]),
// //                   );
...
// //   //   chatProvider.refreshConversations();
// //   //   super.dispose();
// //   //   // Notify the provider to refresh the chat list
// //   //
// //   // }
// // }
// //
...
// //
// //     // Fetch conversations when the widget is built
...
// //               try {
// //                 otherParticipantId = (conversation['participants'] as List<dynamic>)
...
// //                 return ListTile(
// //                   title: Text('No other participant'),
...
//     required this.userId,
//     required this.businessId,
//     this.conversationId = 'KFwYUTlCQrT4RB2a8XLviFYUbU42FOORESSmOcbZ8ors',
//     // required this.conversationId,
//   });
...
class _ChatListScreenState extends State<ChatListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      chatProvider.initializeSocket(widget.userId);
      chatProvider.fetchConversations(widget.userId);
    });
  }
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              final otherParticipant = (conversation['participants'] as List<dynamic>).firstWhere(
                    (participant) => (participant['user_id'] != widget.userId &&
                    participant['business_id'] != widget.userId),
                orElse: () => null,
              );
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        var chatProvider = Provider.of<ChatProvider>(context, listen: false);
        chatProvider.refreshConversations(context, "bbbd");
        return true;
      },
      child: Scaffold(
        appBar: AppBar(
