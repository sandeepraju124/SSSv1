                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) => LocationListTile(
                            press: () async {
                              ...
                              _selectedCriteria2['location'] = placePredictions[index].terms[0].value;
                              setState(() {
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: _selectedCriteria2.entries.map((entry) {
                            return InputChip(
                              side: BorderSide(color: tgLightPrimaryColor, width: 1.0),
                              // selected: true,
                              // showCheckmark: false,
                      ...
                      child: _dropDown(
                        ...
                        onChanged: (String? newvalue) {
                          setState(() {
                            ...
                            _selectedCriteria2['priceRange'] = newvalue == "Price"
                                ? null
