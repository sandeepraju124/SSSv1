              ...
              : RefreshIndicator(
                  ...
                  child: ListView(
                    children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context,
                                  ...
                                  //     businessUid: comment.businessUid);
                                }));
                              },
                              child: Container(
                      ...
                      ...data.getUserActivityData!.questions.map((question) {
                      ...
                      ...data.getUserActivityData!.answers.map((answer) {
                        ...
                        final Question relatedQuestion =
                            data.getUserActivityData!.questions.firstWhere(
                          (question) =>
                          ...
                          orElse: () => Question(
                            ...
                            businessName: '', // Provide a default value
                            businessUid: '', // Provide a default value
                            qdetails: user_activity.Qdetails(
                              createdAt:
                                  DateTime.now(), // Provide a default value
                              questionid: '', // Provide a default value
                        ...
                        return GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              ...
                              subtitle: Padding(
                                padding:
                                    const EdgeInsets.only(top: 1.5, left: 5),
                                child: Text(
