...
//     // Call the userProvider method to fetch the user data
...
//           var data = userProvider.getUserData;
...
//                           backgroundColor: Colors.white,
//                           backgroundImage: NetworkImage(
//                             data?.profile_image_url ?? defaultNetworkImage,
//                           ),
//                           child: Align(
//                             alignment: Alignment.bottomRight,
//                             child: CircleAvatar(
...
//                     children: [
//                       ListTile(
//                         leading: Icon(Icons.group_add, size: 20),
//                         title: Text('Refer', style: TextStyle(fontSize: 15)),
//                         trailing: ElevatedButton(
//                           onPressed: () {
//                             showSnackBar(context, "Feature is currently in progress");
//                           },
//                           child: Text('Invite', style: TextStyle(color: tgPrimaryColor)),
//                         ),
//                       ),
//                       Divider(),
//                       ListTile(
...
//                         },
//                         leading: Icon(Icons.support_agent),
//                         title: Text('Customer support 24x7', style: TextStyle(fontSize: 15)),
//                       ),
//                       Divider(),
//                       ListTile(
//                         onTap: () {
...
//                         },
//                         leading: Icon(Icons.receipt),
//                         title: Text('Terms and conditions', style: TextStyle(fontSize: 15)),
//                       ),
//                       Divider(),
//                       ListTile(
//                         onTap: () async {
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    // Using addPostFrameCallback to fetch user data after the current frame is built
