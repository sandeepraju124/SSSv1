...
class _NewUserProfilePageState extends State<NewUserProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Padding(
        padding: const EdgeInsets.only(top: 68, left: 28),
        child: Column(
          children: [
            Container(
              width: 110,
            ...
            Text(
              ...
              style: TextStyle(fontSize: 13, color: secondaryColor60LightTheme),
            ),
            // SizedBox(height: 2),
            ...
            Text(
              ...
              style: TextStyle(fontSize: 11, color: secondaryColor20LightTheme),
            ),
            SizedBox(height: 12),
