...
class testRealEstate extends StatefulWidget {
  const testRealEstate({Key? key}) : super(key: key);

  @override
  _testRealEstateState createState() => _testRealEstateState();
}

class _testRealEstateState extends State<testRealEstate> {
  Future<List<dynamic>> getData() async {
    String url = 'https://bitebest.azurewebsites.net/services/realestate';
            ...
            return Material(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return SearchListinReal(data: snapshot.data![index]);
                  // ListTile(
                  //   title: Text(snapshot.data![index]['name'] ?? 'No name'),
                  //   subtitle: Text(snapshot.data![index]['rating'] ?? 'No rating'),
                  // );
                },
              ),
            );
...
class _SearchListinRealState extends State<SearchListinReal> {
  @override
  Widget build(BuildContext context) {
    return Column(
            children: [
