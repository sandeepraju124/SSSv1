                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: (displayData[index].profileImageUrl != null &&
                                      displayData[index].profileImageUrl.isNotEmpty)
                                  ? NetworkImage(displayData[index].profileImageUrl)
                                  : NetworkImage('https://www.strasys.uk/wp-content/uploads/2022/02/Depositphotos_484354208_S.jpg'),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
...
//                         blurRadius: 20,
//                         spreadRadius: 1,
//                         color: tgPrimaryColor.withOpacity(0.1),
//                       ),
//                     ],
//                   ),
//                   child: Column(
